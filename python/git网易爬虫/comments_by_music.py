...
import requests
from git网易爬虫 import sql
import time
import threading
import git网易爬虫.cursors
...
if __name__ == '__main__':
    ...
    # pymysql 链接不是线程安全的
    connection1 = git网易爬虫.connect(host='localhost',
                                  user='root',
                                  password='1234',
                                  db='test',
                                  charset='utf8mb4',
                                  cursorclass=git网易爬虫.cursors.DictCursor)

    connection2 = git网易爬虫.connect(host='localhost',
                                  user='root',
                                  password='1234',
                                  db='test',
                                  charset='utf8mb4',
